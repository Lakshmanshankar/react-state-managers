...
export default function TodoUI() {
  console.log("[CONTEXT] INPUT RENDERED");
...
export const ContextTable = (function RenderTodoTables() {
  const { todos, changeStatus, deleteTodo } = useTodo();
  console.log("[CONTEXT] TABLE RENDERED");
  const handleChange = (
...
export function CheckContext() {
  console.log("[CONTEXT] CHECK RENDERED");
  const { addTodo } = useTodo();
  return (
